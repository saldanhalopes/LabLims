 ...
 * @author rafael
 */
public class EscalaMedidaDAO extends GenenicoDAO<EscalaMedida> {

    public EscalaMedida findAll() throws NoResultException {
        EntityManager em = ConnectionFactory.em();
        try {
            return em.createNamedQuery("EscalaMedida.findAll", EscalaMedida.class)
                    .getSingleResult();
