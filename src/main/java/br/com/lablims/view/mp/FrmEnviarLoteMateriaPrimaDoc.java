 ...
 * @author rafael.lopes
 */
public class FrmEnviarLoteMateriaPrimaDoc extends javax.swing.JFrame {
     ...
     */
    public FrmEnviarLoteMateriaPrimaDoc() {
        initComponents();
        Frames.setUpFrame(this, "Enviar Lotes para Documental", false);
    ...
    private void initComponents() {
        ...
        tblLoteMateriaPrima.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Enviar", "Lote_Id", "Lote", "Cod_Material", "Material", "Data Necessidade", "Status SAP", "Prev. Liberação", "Observações"
            }
        ) {
        ...
        btnLiberar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/icon_enviar_doc_32.png"))); // NOI18N
        btnLiberar.setText("Enviar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEnviarLoteMateriaPrimaDoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FrmEnviarLoteMateriaPrimaDoc().setVisible(true);
            }
        });
    }
    ...
    private void enviar() {
        if (AcessoSistema.editarDados(ACESSO)) {
            int dialogResult = JOptionPane.showConfirmDialog(null, "Deseja Enviar esses Lotes para o Documental?",
                    ...
                    if (senha.Salvar()) {
                        ...
                        for (int row = 0; row < rows; row++) {
                            if ((Boolean) tblLoteMateriaPrima.getValueAt(row, 0)) {
                                ...
                                loteInfo.setDataDoc(new Date());
                                loteInfo.setVersion(loteInfo.getVersion() + 1);
                                loteInfoDAO.salvar(loteInfo);
                                //Atualizar Lote Status
                                for (LoteMateriaPrimaStatus loteStatus
                                        : loteStatusDAO.findLotesByStatus((Long) tblLoteMateriaPrima.getValueAt(row, 1))) {
                                    loteStatus.setConferido(true);
