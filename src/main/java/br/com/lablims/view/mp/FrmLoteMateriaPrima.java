 ...
 * @author rafael.lopes
 */
public class FrmLoteMateriaPrima extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblLoteMateriaPrima.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Status", "Lote_Id", "Lote", "Cod_Material", "Material", "Data Necessidade", "Qtd Estoque", "Status SAP", "Prev. Liberação", "Data Vencimento", "Qtd. Volumes", "Observações", "Version"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Boolean.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class, java.lang.Object.class, java.lang.Double.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class
            };
        ...
        if (tblLoteMateriaPrima.getColumnModel().getColumnCount() > 0) {
            ...
            tblLoteMateriaPrima.getColumnModel().getColumn(6).setMinWidth(100);
            tblLoteMateriaPrima.getColumnModel().getColumn(6).setPreferredWidth(100);
            tblLoteMateriaPrima.getColumnModel().getColumn(6).setMaxWidth(100);
            tblLoteMateriaPrima.getColumnModel().getColumn(7).setMinWidth(300);
            tblLoteMateriaPrima.getColumnModel().getColumn(7).setPreferredWidth(300);
            tblLoteMateriaPrima.getColumnModel().getColumn(7).setMaxWidth(300);
            ...
            tblLoteMateriaPrima.getColumnModel().getColumn(9).setMinWidth(180);
            tblLoteMateriaPrima.getColumnModel().getColumn(9).setPreferredWidth(180);
            tblLoteMateriaPrima.getColumnModel().getColumn(9).setMaxWidth(180);
            tblLoteMateriaPrima.getColumnModel().getColumn(10).setMinWidth(80);
            tblLoteMateriaPrima.getColumnModel().getColumn(10).setPreferredWidth(80);
            tblLoteMateriaPrima.getColumnModel().getColumn(10).setMaxWidth(80);
            tblLoteMateriaPrima.getColumnModel().getColumn(11).setPreferredWidth(500);
            tblLoteMateriaPrima.getColumnModel().getColumn(12).setMinWidth(80);
            tblLoteMateriaPrima.getColumnModel().getColumn(12).setPreferredWidth(80);
            tblLoteMateriaPrima.getColumnModel().getColumn(12).setMaxWidth(80);
        }
        ...
        jTabbedPane1.addTab("Lotes Matéria Prima", pnlMetodologia);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLoteMateriaPrima.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FrmLoteMateriaPrima().setVisible(true);
            }
        });
    }
