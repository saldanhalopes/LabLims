...
import static br.com.lablims.view.mp.FrmProgramacaoPorAnalise.tblProgramacaoLaboratorio;
 ...
 * @author rafael.lopes
 */
public class FrmAbrirProgramacaoPorAnalise extends javax.swing.JDialog {

    FrmProgramacaoPorAnalise frm;
     ...
     * @param modal
     */
    public FrmAbrirProgramacaoPorAnalise(java.awt.Frame parent, boolean modal, FrmProgramacaoPorAnalise form) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAbrirProgramacaoPorAnalise.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FrmAbrirProgramacaoPorAnalise dialog = new FrmAbrirProgramacaoPorAnalise(new javax.swing.JFrame(), true, null);
    ...
    private void abrir() {
        ...
        try {
            if (frm == null || !frm.isVisible()) {
                frm = new FrmProgramacaoPorAnalise();
                criarJanela(title, new PnlProgramacaoPorAnalise(title));
                frm.setVisible(true);
