 ...
 * @author rafael.lopes
 */
public class FrmLoteMateriaPrimaStatusAnalise extends javax.swing.JFrame {
     ...
     */
    public FrmLoteMateriaPrimaStatusAnalise() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLoteMateriaPrimaStatusAnalise.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FrmLoteMateriaPrimaStatusAnalise().setVisible(true);
            }
        });
    }
