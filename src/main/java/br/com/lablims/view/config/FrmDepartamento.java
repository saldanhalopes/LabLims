...
public class FrmDepartamento extends javax.swing.JFrame {
    ...
    public FrmDepartamento() {
        initComponents();
        Frames.setUpFrame(this, "Departamentos", false);
        readDepartamento();
    ...
    private void initComponents() {
        ...
        pnlDepartamentos = new javax.swing.JTabbedPane();
        ...
        tblDepartamentoAuditoria = new javax.swing.JTable();
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Departamentos"));
        ...
        tblDepartamento.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Depart_Id", "Sigla", "Departamento", "Descrição", "Versão"
            }
        ) {
        ...
        tblDepartamento.setSurrendersFocusOnKeystroke(true);
        tblDepartamento.getTableHeader().setReorderingAllowed(false);
        tblDepartamento.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblDepartamentoMouseClicked(evt);
            }
        });
        tblDepartamento.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tblDepartamentoKeyReleased(evt);
            }
        });
        jScrollPane1.setViewportView(tblDepartamento);
        if (tblDepartamento.getColumnModel().getColumnCount() > 0) {
            tblDepartamento.getColumnModel().getColumn(0).setMinWidth(80);
            tblDepartamento.getColumnModel().getColumn(0).setPreferredWidth(80);
            tblDepartamento.getColumnModel().getColumn(0).setMaxWidth(80);
            tblDepartamento.getColumnModel().getColumn(1).setMinWidth(100);
            tblDepartamento.getColumnModel().getColumn(1).setPreferredWidth(100);
            tblDepartamento.getColumnModel().getColumn(2).setMinWidth(300);
            tblDepartamento.getColumnModel().getColumn(2).setPreferredWidth(300);
            tblDepartamento.getColumnModel().getColumn(3).setMinWidth(300);
            tblDepartamento.getColumnModel().getColumn(3).setPreferredWidth(300);
            tblDepartamento.getColumnModel().getColumn(4).setMinWidth(50);
            tblDepartamento.getColumnModel().getColumn(4).setPreferredWidth(50);
            tblDepartamento.getColumnModel().getColumn(4).setMaxWidth(50);
        }
        ...
        pnlDepartamentos.addTab("Departamentos", jPanel1);

        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Auditoria de Analises"));

        tblDepartamentoAuditoria.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Depart_Id", "Versão", "MOD", "Sigla", "Sigla_MOD", "Departamento", "Departamento_MOD", "Descrição", "Descrição_MOD", "Computador / AD_User ", "Usuario", "Data Modificação", "Motivo"
            }
        ) {
            Class[] types = new Class [] {
        ...
        tblDepartamentoAuditoria.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        jScrollPane2.setViewportView(tblDepartamentoAuditoria);
        if (tblDepartamentoAuditoria.getColumnModel().getColumnCount() > 0) {
            tblDepartamentoAuditoria.getColumnModel().getColumn(0).setMinWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(0).setPreferredWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(0).setMaxWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(1).setMinWidth(80);
            tblDepartamentoAuditoria.getColumnModel().getColumn(1).setPreferredWidth(80);
            tblDepartamentoAuditoria.getColumnModel().getColumn(1).setMaxWidth(80);
            tblDepartamentoAuditoria.getColumnModel().getColumn(2).setMinWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(2).setPreferredWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(2).setMaxWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(3).setMinWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(3).setPreferredWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(4).setMinWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(4).setPreferredWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(5).setMinWidth(300);
            tblDepartamentoAuditoria.getColumnModel().getColumn(5).setPreferredWidth(300);
            tblDepartamentoAuditoria.getColumnModel().getColumn(6).setMinWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(6).setPreferredWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(7).setMinWidth(400);
            tblDepartamentoAuditoria.getColumnModel().getColumn(7).setPreferredWidth(400);
            tblDepartamentoAuditoria.getColumnModel().getColumn(8).setMinWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(8).setPreferredWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(9).setMinWidth(150);
            tblDepartamentoAuditoria.getColumnModel().getColumn(9).setPreferredWidth(150);
            tblDepartamentoAuditoria.getColumnModel().getColumn(10).setMinWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(10).setPreferredWidth(100);
            tblDepartamentoAuditoria.getColumnModel().getColumn(11).setMinWidth(120);
            tblDepartamentoAuditoria.getColumnModel().getColumn(11).setPreferredWidth(120);
            tblDepartamentoAuditoria.getColumnModel().getColumn(11).setMaxWidth(120);
            tblDepartamentoAuditoria.getColumnModel().getColumn(12).setMinWidth(800);
            tblDepartamentoAuditoria.getColumnModel().getColumn(12).setPreferredWidth(800);
        }
        ...
        pnlDepartamentos.addTab("Audit Trail", jPanel2);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlDepartamentos)
        );
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (tblDepartamento.getSelectedRow() != -1) {
            atualizar();
        }
    ...
    private void txtPesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisarKeyReleased
        TableSorter.TableSorter(tblDepartamento, txtPesquisar);
    ...
    private void txtPesquisarAuditoriaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisarAuditoriaKeyReleased
        TableSorter.TableSorter(tblDepartamentoAuditoria, txtPesquisarAuditoria);
    ...
    private void tblDepartamentoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblDepartamentoKeyReleased
        if (tblDepartamento.getSelectedRow() != -1) {
            if (evt.getKeyCode() == KeyEvent.VK_DELETE) {
                deletar();
            }
        }
    }//GEN-LAST:event_tblDepartamentoKeyReleased
    ...
    private javax.swing.JTabbedPane pnlDepartamentos;
    private javax.swing.JTable tblDepartamento;
    private javax.swing.JTable tblDepartamentoAuditoria;
    private javax.swing.JTextField txtPesquisar;
    private javax.swing.JTextField txtPesquisarAuditoria;
    // End of variables declaration//GEN-END:variables

    public final void readDepartamento() {
        DefaultTableModel model = (DefaultTableModel) tblDepartamento.getModel();
        DepartamentoDAO departamentoDAO = new DepartamentoDAO();
        model.setNumRows(0);
        try {
            for (Departamento departamento : departamentoDAO.findEntities(Departamento.class)) {
                model.addRow(new Object[]{
                    departamento.getId(),
                    departamento.getSiglaDepartamento(),
    ...
    private void abrir() {
        try {
            new FrmDepartamentoDados(null, true).setVisible(true);
        } catch (Exception e) {
    ...
    private void atualizar() {
        if (AcessoSistema.editarDados(ACESSO)) {
            ...
            try {
                ...
                Departamento departamento = departamentoDAO.findById(Departamento.class, (Long) tblDepartamento.getValueAt(tblDepartamento.getSelectedRow(), 0));
                new FrmDepartamentoDados(null, true, departamento).setVisible(true);
        ...
        if (AcessoSistema.deletarDados(ACESSO)) {
            ...
            try {
                ...
                if (dialogResult == 0) {
                    if (senha.Salvar()) {
                        Departamento departamento = departamentoDAO.findById(Departamento.class, (Long) tblDepartamento.getValueAt(tblDepartamento.getSelectedRow(), 0));
                        departamentoDAO.remover(Departamento.class, departamento.getId());
                    }
                }
            } catch (Exception e) {
    ...
    private void carregarAuditoria() {
        DefaultTableModel model = (DefaultTableModel) tblDepartamentoAuditoria.getModel();
        DepartamentoDAO departamentoDAO = new DepartamentoDAO();
        model.setNumRows(0);
        try {
            for (Departamento departamento : departamentoDAO.readDepartamentoAuditoria()) {
                model.addRow(new Object[]{
                    departamento.getId(),
                    departamento.getVersion(),
                    departamento.getAudit().getMOD() == 0 ? "Criado" : (departamento.getAudit().getMOD() == 1 ? "Modificado" : "Removido"),
                    departamento.getDepartamento(),
                    departamento.getDepartamento_MOD() == false ? "Não Alterado" : "Alterado",
                    departamento.getSiglaDepartamento(),
                    departamento.getSigla_Departamento_MOD() == false ? "Não Alterado" : "Alterado",
                    departamento.getDescricaoDepartamento(),
                    departamento.getDescricao_Departamento_MOD() == false ? "Não Alterado" : "Alterado",
                    departamento.getAudit().getComputador() + " / "
                    + departamento.getAudit().getUserComputador(),
                    departamento.getAudit().getUltimaModificacaoPor(),
                    DataHora.getStringDateTime(departamento.getAudit().getUltimaModificacao()),
                    departamento.getAudit().getMotivo()
                });
            }
        } catch (Exception e) {
        }
