...
public final class FrmSalvar extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FrmSalvar(java.awt.Frame parent, boolean modal, EntityManager etm, Senha senha) {
        super(parent, modal);
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FrmSalvar dialog = new FrmSalvar(new javax.swing.JFrame(), true, null, null);
    ...
    private void senha() {
        try {
            if (txtMotivo.getText().trim().isEmpty()) {
                ...
                Usuario user = new UsuarioDAO().buscaUsuarioLogin(em, new Usuario(usuario, senha));
                Integer falhas;
                Integer falha;
                try {
                    falhas = user.getFailed_access_count() == null ? 0 : user.getFailed_access_count();
                    falha = new SegurancaDAO().findById(em, Seguranca.class, 1).getNumero();
                } catch (Exception e) {
                    falhas = 0;
                    falha = 10;
                }
