...
public class FrmMetodologia extends javax.swing.JFrame {
    ...
    public FrmMetodologia() {
        initComponents();
        Frames.setUpFrame(this, "Metodologias", false);
        readMetodologia();
    ...
    private void initComponents() {
        ...
        tblMetodologia.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Metodologia_Id", "Código", "Método", "Categoria", "Obs"
            }
        ) {
        ...
        tblMetodologia.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        ...
        if (tblMetodologia.getColumnModel().getColumnCount() > 0) {
            ...
            tblMetodologia.getColumnModel().getColumn(2).setMinWidth(400);
            tblMetodologia.getColumnModel().getColumn(2).setPreferredWidth(400);
            tblMetodologia.getColumnModel().getColumn(3).setMinWidth(400);
            tblMetodologia.getColumnModel().getColumn(3).setPreferredWidth(400);
            tblMetodologia.getColumnModel().getColumn(4).setPreferredWidth(500);
        }
        ...
        tblGruposAuditoria.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Metodologia_Id", "Versão", "MOD", "Cod_Metodo", "Cod_Metodo_MOD", "Categoria", "Categoria_MOD", "Metodo", "Metodo_MOD", "Tipo", "Tipo_MOD", "Obs", "Obs_MOD", "Material_MOD", "Computador / AD_User ", "Usuario", "Data Modificação", "Motivo"
            }
        ) {
            Class[] types = new Class [] {
        ...
        if (tblGruposAuditoria.getColumnModel().getColumnCount() > 0) {
            ...
            tblGruposAuditoria.getColumnModel().getColumn(12).setMaxWidth(100);
            tblGruposAuditoria.getColumnModel().getColumn(13).setMinWidth(80);
            tblGruposAuditoria.getColumnModel().getColumn(13).setPreferredWidth(80);
            tblGruposAuditoria.getColumnModel().getColumn(13).setMaxWidth(80);
            tblGruposAuditoria.getColumnModel().getColumn(14).setMinWidth(200);
            tblGruposAuditoria.getColumnModel().getColumn(14).setPreferredWidth(200);
            tblGruposAuditoria.getColumnModel().getColumn(15).setMinWidth(150);
            tblGruposAuditoria.getColumnModel().getColumn(15).setPreferredWidth(150);
            ...
            tblGruposAuditoria.getColumnModel().getColumn(17).setMinWidth(800);
            tblGruposAuditoria.getColumnModel().getColumn(17).setPreferredWidth(800);
        }
    ...
    public final void readMetodologia() {
        ...
        model.setNumRows(0);
        try {
            for (Metodologia mtd : mtdDAO.findEntities(Metodologia.class)) {
    ...
    private void atualizar() {
        if (AcessoSistema.editarDados(ACESSO)) {
            ...
            try {
                ...
                Metodologia mtd = mtdDAO.findById(Metodologia.class, (Long) tblMetodologia.getValueAt(tblMetodologia.getSelectedRow(), 0));
                new FrmMetodologiaMenuEditar(null, true, mtd).setVisible(true);
        ...
        if (AcessoSistema.deletarDados(ACESSO)) {
            ...
            try {
                ...
                if (dialogResult == 0) {
                    if (senha.Salvar()) {
                        Metodologia mtd = mtdDAO.findById(Metodologia.class, (Long) tblMetodologia.getValueAt(tblMetodologia.getSelectedRow(), 0));
                        mtdDAO.remover(Metodologia.class, mtd.getId());
                    }
                }
            } catch (Exception e) {
        ...
        try {
            for (Metodologia mtd : mtdDAO.readMetodologiaAuditoria()) {
                model.addRow(new Object[]{
                    ...
                    mtd.getCodMetodo(),
                    mtd.getCodMetodo_MOD() == false ? "Não Alterado" : "Alterado",
                    mtd.getCategoria(),
                    mtd.getCategoria_MOD() == false ? "Não Alterado" : "Alterado",
                    mtd.getMetodo(),
                    mtd.getMetodo_MOD() == false ? "Não Alterado" : "Alterado",
                    mtd.getObs(),
                    mtd.getObs_MOD() == false ? "Não Alterado" : "Alterado",
                    mtd.getMaterial_MOD() == false ? "Não Alterado" : "Alterado",
