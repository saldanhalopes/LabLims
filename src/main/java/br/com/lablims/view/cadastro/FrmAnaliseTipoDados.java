...
public class FrmAnaliseTipoDados extends javax.swing.JDialog {
    ...
    public FrmAnaliseTipoDados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Frames.setUpFrame(this, "Dados do Tipo de Análise", true);
        limparCampos();
    ...
    private void criarAnaliseTipo() {
        ...
        try {
            ...
            anls.setVersion(0);
            analiseDAO.salvar(anls);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Erro ao gravar dados: " + e);
        }
    }

    private void atulizarAnaliseTipo() {
        AnaliseTipo anls = new AnaliseTipo();
        AnaliseTipoDAO analiseDAO = new AnaliseTipoDAO();
        try {
    ...
    private void limparCampos() {
        txtSiglaAnaliseTipo.setDocument(new FieldFormatLimit(10, FieldFormatLimit.LETRAS_NUMEROS_MAIUSCULO));
