...
public class FrmAnalise extends javax.swing.JFrame {
            ...
            .addGroup(pnlAnaliseLayout.createSequentialGroup()
                .addGroup(pnlAnaliseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlAnaliseLayout.createSequentialGroup()
                        ...
                        .addComponent(txtPesquisar, javax.swing.GroupLayout.DEFAULT_SIZE, 893, Short.MAX_VALUE))
                    .addGroup(pnlAnaliseLayout.createSequentialGroup()
                        .addContainerGap()
    ...
    private void txtPesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisarKeyReleased
        TableSorter.Sorter(tblAnalise, txtPesquisar);
    ...
    private void txtPesquisarAuditoriaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisarAuditoriaKeyReleased
        TableSorter.Sorter(tblAnaliseAuditoria, txtPesquisarAuditoria);
    ...
    public final void readAnalise() {
        ...
        model.setNumRows(0);
        try {
            for (Analise analise : analiseDAO.findEntities(em, Analise.class)) {
    ...
    private void atualizar() {
        ...
        try {
            ...
            Analise analise = analiseDAO.findById(em, Analise.class, (Integer) tblAnalise.getValueAt(tblAnalise.getSelectedRow(), 0));
    ...
    private void deletar() {
        ...
        try {
            ...
            if (dialogResult == 0) {
                ...
                if (senha.getSenha()) {
                    Analise analise = analiseDAO.findById(em, Analise.class, (Integer) tblAnalise.getValueAt(tblAnalise.getSelectedRow(), 0));
                    analiseDAO.remover(em, Analise.class, analise.getId());
                }
            }
        } catch (Exception e) {
        ...
        try {
            for (Analise analise : analiseDAO.readAnaliseAuditoria()) {
                model.addRow(new Object[]{
                    analise.getId(),
                    analise.getVersion(),
                    analise.getMOD() == 0 ? "Criado" : (analise.getMOD() == 1 ? "Modificado" : "Removido"),
                    analise.getAnalise(),
                    analise.getAnalise_MOD() == 0 ? "Não Alterado" : "Alterado",
                    analise.getSiglaAnalise(),
                    analise.getSigla_Analise_MOD() == 0 ? "Não Alterado" : "Alterado",
                    analise.getDescricaoAnalise(),
                    analise.getDescricao_Analise_MOD() == 0 ? "Não Alterado" : "Alterado",
