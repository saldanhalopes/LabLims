...
public class FrmAnaliseDados extends javax.swing.JDialog {
    ...
    public FrmAnaliseDados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Frames.setUpFrame(this, "Dados da Analise", true);
        carregarCampos();
        novoAnalise = true;
    }
    ...
    private void carregarCampos() {
        txtSiglaAnalise.setDocument(new FieldFormatLimit(10, FieldFormatLimit.LETRAS_NUMEROS_MAIUSCULO));
