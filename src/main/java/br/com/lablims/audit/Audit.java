...
public class Audit implements Serializable {
    ...
    public String toString() {
        return "Audit{" + "ultimaModificacao=" + ultimaModificacao + ", ultimaModificacaoPor=" + ultimaModificacaoPor + ", computador=" + computador + ", userComputador=" + userComputador + ", motivo=" + motivo + '}';
    }
