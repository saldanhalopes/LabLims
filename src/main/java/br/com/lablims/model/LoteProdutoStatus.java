 ...
 */
@Entity
@Table(name = "tb_lote_produto_status")
@NamedQueries({
    @NamedQuery(name = "LoteProdutoStatus.findStatus", query = "Select sts FROM LoteProdutoStatus sts "
            + "WHERE sts.lote.id = :lote_id ORDER BY sts.planoAnalise.descricao ASC"),
    @NamedQuery(name = "LoteProdutoStatus.findStatusByLoteAndPlanoAnalise", query = "Select sts "
            + "FROM LoteProdutoStatus sts WHERE sts.lote.id = :lote_id AND sts.planoAnalise.id = :pa_id"),
    @NamedQuery(name = "LoteProdutoStatus.findStatusByPlanoAnalise", query = "Select sts "
            + "FROM LoteProdutoStatus sts WHERE sts.planoAnalise.id = :pa_id"),
    @NamedQuery(name = "LoteProdutoStatus.findStatusByLoteAndAnalise", query = "Select sts "
            + "FROM LoteProdutoStatus sts WHERE sts.lote.id = :lote_id AND sts.planoAnalise.analise.id = :analise_id")})
@DynamicInsert(true)
@DynamicUpdate(true)
@Audited(withModifiedFlag = true)
@AuditTable(value = "tba_lote_produto_status_auditoria")
@EntityListeners(AuditListener.class)
public class LoteProdutoStatus implements EntidadeBase, Serializable {
    ...
    public LoteProdutoStatus() {
    }

    public LoteProdutoStatus(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final LoteProdutoStatus other = (LoteProdutoStatus) obj;
