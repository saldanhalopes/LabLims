...
public class AnaliseTipo implements EntidadeBase, Serializable {
    ...
    @Transient
    private Integer AnaliseTipo_MOD;
    
    @Transient
    private Integer Descricao_AnaliseTipo_MOD;
    
    @Transient
    private Integer Sigla_AnaliseTipo_MOD;
    ...
    public Integer getAnaliseTipo_MOD() {
        return AnaliseTipo_MOD;
    }

    public void setAnaliseTipo_MOD(Integer AnaliseTipo_MOD) {
        this.AnaliseTipo_MOD = AnaliseTipo_MOD;
    }

    public Integer getDescricao_AnaliseTipo_MOD() {
        return Descricao_AnaliseTipo_MOD;
    }

    public void setDescricao_AnaliseTipo_MOD(Integer Descricao_AnaliseTipo_MOD) {
        this.Descricao_AnaliseTipo_MOD = Descricao_AnaliseTipo_MOD;
    }

    public Integer getSigla_AnaliseTipo_MOD() {
        return Sigla_AnaliseTipo_MOD;
    }

    public void setSigla_AnaliseTipo_MOD(Integer Sigla_AnaliseTipo_MOD) {
