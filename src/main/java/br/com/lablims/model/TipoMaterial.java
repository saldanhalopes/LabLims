...
import org.hibernate.envers.Audited;
 ...
 /**
 * O <code>TipoMaterial</code> classe TipoMaterial
 *
 * @author rafae.lopes
 * @version 1.00
 */
...
@AuditTable(value = "tba_tipo_material_auditoria")
@EntityListeners(AuditListener.class)
public class TipoMaterial implements EntidadeBase, Serializable {
    ...
    public Boolean getSigla_MOD() {
        return Sigla_MOD;
    }

    public void setSigla_MOD(Boolean Sigla_MOD) {
        this.Sigla_MOD = Sigla_MOD;
    }
